...
(function (window) {
	...
	/**
	 * Abstract dom element used as private event bus
	 *
	 * @type {HTMLElement}
	 * @private
	 */
	 ...
	 * @example var eventId = Event.add('showPopup', function(data, event) {
	 *      alert(data.message);
	 * })
	 */
	exports.prototype.add = function (type, func, capture) {
		if (typeof type === 'string'
			...
			var callback = function(event) {
				func(event.detail, event);
			};
			eventEl.addEventListener(type, callback, capture);
